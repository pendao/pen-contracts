...
async function main() {
    ...
    const PEN = "0x383518188c0c6d7730d91b2c03a03c837814a899";
    ...
    const CVXBond = await ethers.getContractFactory('PenDaoCVXBondDepository');

    // Deploy CVX bond
    const cvxBond = await CVXBond.deploy(PEN, CVX, Treasury, DAO);
