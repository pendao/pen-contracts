...
describe('PenDao Staking', () => {
    ...
    beforeEach(async () => {
        ...
        OLY = await ethers.getContractFactory('PenDaoERC20TOken');
        oly = await OLY.deploy();

        Staking = await ethers.getContractFactory('PenDaoStaking');
        ...
        sOLY = await ethers.getContractFactory('sPenDao');
